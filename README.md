...
[![circle-ci](https://img.shields.io/circleci/project/github/Wolox/react-chat-jordan.svg)](https://circleci.com/gh/Wolox/react-chat-jordan)
[![npm](https://img.shields.io/npm/v/react-chat-jordan.svg)](https://www.npmjs.com/package/react-chat-jordan)
...
<div>
    <br/>
    <p align="center">
        <a href="https://getstream.io/chat/?utm_source=github&utm_medium=react-chat-jordan&utm_campaign=sponsorship" target="_blank">
    ...
    <div>
        <p align="center">
            A scalable <a href="https://getstream.io/chat/?utm_source=github&utm_medium=react-chat-jordan&utm_campaign=sponsorship" target="_blank">Chat API/Server</a> written in Go
        </p>
    </div>
    <div>
        <p align="center">
            <a href="https://getstream.io/chat/get_started/?utm_source=github&utm_medium=react-chat-jordan&utm_campaign=sponsorship" target="_blank">API Tour</a> | <a href="https://github.com/getstream/stream-sdks?utm_source=github&utm_medium=react-chat-jordan&utm_campaign=sponsorship" target="_blank">SDKs</a> | <a href="https://getstream.io/chat/docs/?utm_source=github&utm_medium=react-chat-jordan&utm_campaign=sponsorship" target="_blank">Docs</a>
        </p>
    </div>
</div>
...
```bash
npm install --save react-chat-jordan
```

#### yarn

```bash
yarn add react-chat-jordan
```
...
import { Widget } from "react-chat-jordan";
...
```js
import React from "react";
import { Widget, addResponseMessage } from "react-chat-jordan";
...
- **addLinkSnippet**
  ...
  - Method to add a link snippet. You need to provide this method with a link object, which must be in the shape of:
    ```js
    {
      ...
      link: 'https://github.com/Wolox/react-chat-jordan',
      target: '_blank'
    }
    ```
